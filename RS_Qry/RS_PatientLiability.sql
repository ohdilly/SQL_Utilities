...
AND bs.base_set_type = 'RS_PatientLiability'
--AND  set_sl.config_id = 551
order by 1),
fv as (  
   	
	select nvl(ev.value, 'NONE') as FValu  ,tg.label as Fld, ev.validation_set_config_id as config_id
   from
